...
public class FunGameHeader extends FrameLayout {
    ...
    private String topMaskViewText = "玩个游戏解解闷";
    private String bottomMaskViewText = "上下滑动控制游戏";
    private String loadingText = "糖小厨大作战";
    private String loadingFinishedText = "这些果蔬尽量少吃哦";
    ...
    public FunGameHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        headerType = typedArray.getInt(R.styleable.FunGameHeader_game_type, FunGameFactory.BATTLECITY);
