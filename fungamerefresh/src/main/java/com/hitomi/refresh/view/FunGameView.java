...
abstract class FunGameView extends View {
    ...
    protected int lModelColor, rModelColor, wModelColor,mModelColor,bModelColor;
    ...
    public FunGameView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        wModelColor = //typedArray.getColor(R.styleable.FunGame_middle_model_color, Color.WHITE);
        bModelColor = typedArray.getColor(R.styleable.FunGame_left_model_color, Color.rgb(139, 69, 19));
